...
TSharedPtr<FSlateStyleSet> FSimpleProgramObjectReflectorStyle::StyleInstance = nullptr;

void FSimpleProgramObjectReflectorStyle::Initialize()
{
...
void FSimpleProgramObjectReflectorStyle::Shutdown()
{
...
FName FSimpleProgramObjectReflectorStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("SimpleProgramObjectReflectorStyle"));
	return StyleSetName;
}
...
TSharedRef< FSlateStyleSet > FSimpleProgramObjectReflectorStyle::Create()
{
	TSharedRef<FSimpleProgramObjectReflectorStyleSet> Style = MakeShareable(new FSimpleProgramObjectReflectorStyleSet);
	Style->Initialize();
	return Style;
}

void FSimpleProgramObjectReflectorStyle::ReloadTextures()
{
...
const ISlateStyle& FSimpleProgramObjectReflectorStyle::Get()
{
	return *StyleInstance;
}


FSimpleProgramObjectReflectorStyle::FSimpleProgramObjectReflectorStyleSet::FSimpleProgramObjectReflectorStyleSet()
	: FSlateStyleSet(FSimpleProgramObjectReflectorStyle::GetStyleSetName())
{

}

void FSimpleProgramObjectReflectorStyle::FSimpleProgramObjectReflectorStyleSet::Initialize()
{
	if (TSharedPtr<IPlugin> Plugin = IPluginManager::Get().FindPlugin("SimpleProgramObjectReflector"))
	{
	...
	Set("SimpleProgramObjectReflector.OpenPluginWindow", new IMAGE_BRUSH_SVG(TEXT("PlaceholderButtonIcon"), Icon20x20));
#if IS_PROGRAM
	{
		//EditorStyle
