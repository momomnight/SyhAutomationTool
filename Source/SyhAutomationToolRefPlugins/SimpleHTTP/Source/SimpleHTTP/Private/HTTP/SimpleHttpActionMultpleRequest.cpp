...
bool FSimpleHttpActionMultpleRequest::PutObject(const FString &URL, const FString &LocalPaths)
{
	...
	{
		UE_LOG(LogSimpleHTTP, Error, TEXT("The obtained content is empty. Please check whether there are resources under this path.[%s]"), *LocalPaths);
		return false;
	}
...
void FSimpleHttpActionMultpleRequest::HttpRequestProgress64(FHttpRequestPtr Request, uint64 BytesSent, uint64 BytesReceived)
{
