...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USimplePlayer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USimplePlayer_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USimplePlayer_Statics::Class_MetaDataParams), Z_Construct_UClass_USimplePlayer_Statics::Class_MetaDataParams)
	};
	...
	USimplePlayer::~USimplePlayer() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimplePlayer_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimplePlayer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimplePlayer, USimplePlayer::StaticClass, TEXT("USimplePlayer"), &Z_Registration_Info_UClass_USimplePlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimplePlayer), 2364830134U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimplePlayer_h_1359217418(TEXT("/Script/SimpleNetChannel"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimplePlayer_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimplePlayer_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
