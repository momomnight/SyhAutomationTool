...
// End Cross Module References
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::NewProp_InType = { "InType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(SimpleController_eventLinkServerInfo_Parms, InType), Z_Construct_UEnum_SimpleNetChannel_ESimpleNetErrorType, METADATA_PARAMS(nullptr, 0) }; // 1223642419
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::NewProp_InMsg = { "InMsg", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(SimpleController_eventLinkServerInfo_Parms, InMsg), METADATA_PARAMS(Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::NewProp_InMsg_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::NewProp_InMsg_MetaData)) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USimpleController, nullptr, "LinkServerInfo", nullptr, nullptr, sizeof(Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::SimpleController_eventLinkServerInfo_Parms), Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USimpleController_LinkServerInfo_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USimpleController_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USimpleController_LinkServerInfo, "LinkServerInfo" }, // 1925054838
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USimpleController_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_USimpleController_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USimpleController_Statics::Class_MetaDataParams))
	};
	...
	USimpleController::~USimpleController() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimpleController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimpleController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimpleController, USimpleController::StaticClass, TEXT("USimpleController"), &Z_Registration_Info_UClass_USimpleController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimpleController), 1508514298U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimpleController_h_1513063301(TEXT("/Script/SimpleNetChannel"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimpleController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_SimpleController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
