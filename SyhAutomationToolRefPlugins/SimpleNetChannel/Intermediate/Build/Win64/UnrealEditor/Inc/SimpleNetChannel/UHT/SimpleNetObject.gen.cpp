...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleNetworkObject_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_USimpleNetworkObject_Statics::NewProp_LinkState_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USimpleNetworkObject_Statics::NewProp_LinkState_MetaData[] = {
		{ "ModuleRelativePath", "Public/UObject/Core/SimpleNetObject.h" },
	};
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USimpleNetworkObject_Statics::NewProp_LinkState = { "LinkState", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USimpleNetworkObject, LinkState), Z_Construct_UEnum_SimpleNetChannel_ESimpleNetLinkState, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleNetworkObject_Statics::NewProp_LinkState_MetaData), Z_Construct_UClass_USimpleNetworkObject_Statics::NewProp_LinkState_MetaData) }; // 59452332
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USimpleNetworkObject_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleNetworkObject_Statics::Class_MetaDataParams), Z_Construct_UClass_USimpleNetworkObject_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleNetworkObject_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_Core_SimpleNetObject_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_Core_SimpleNetObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimpleNetworkObject, USimpleNetworkObject::StaticClass, TEXT("USimpleNetworkObject"), &Z_Registration_Info_UClass_USimpleNetworkObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimpleNetworkObject), 1205033630U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_Core_SimpleNetObject_h_463617419(TEXT("/Script/SimpleNetChannel"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_Core_SimpleNetObject_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_SyhAutomationToolRefPlugins_SimpleNetChannel_Source_SimpleNetChannel_Public_UObject_Core_SimpleNetObject_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
