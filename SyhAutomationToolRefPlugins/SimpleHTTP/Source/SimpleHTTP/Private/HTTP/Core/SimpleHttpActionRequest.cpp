...
bool FSimpleHttpActionRequest::SendRequest(ESimpleHTTPVerbType InType,const FString& URL, const TMap<FString, FString>& InMeta, const FString& InConentData)
{
	return false;
}

bool FSimpleHttpActionRequest::SendRequest(ESimpleHTTPVerbType InType, const FString& URL, const TMap<FString, FString>& InMeta, const TArray<uint8>& InData)
{
	return false;
}
...
void FSimpleHttpActionRequest::HttpRequestProgress64(FHttpRequestPtr Request, uint64 BytesSent, uint64 BytesReceived)
{
...
bool FSimpleHttpActionRequest::PostObject(const FString& URL, const FString& LocalPaths)
{
	return false;
}

bool FSimpleHttpActionRequest::PostObject(const FString& URL, const TArray<uint8>& Data)
{
	return false;
}

void FSimpleHttpActionRequest::RequestPtrToSimpleRequest(FHttpRequestPtr Request, FSimpleHttpRequest& SimpleHttpRequest)
{
	if (Request.IsValid())
	{
		...
		SimpleHttpRequest.RowPtr = &Request;
	}
}

void FSimpleHttpActionRequest::ResponsePtrToSimpleResponse(FHttpResponsePtr Response, FSimpleHttpResponse& SimpleHttpResponse)
{
	if (Response.IsValid())
	{
		...
		SimpleHttpResponse.RowPtr = &Response;
	}
}