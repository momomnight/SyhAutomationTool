...
{
	SIMPLE_POST		UMETA(DisplayName = "Post"),
	SIMPLE_PUT		UMETA(DisplayName = "Put"),
	SIMPLE_GET		UMETA(DisplayName = "Get"),
	SIMPLE_DELETE	UMETA(DisplayName = "Delete")
};
...
DECLARE_DYNAMIC_DELEGATE_ThreeParams(FSimpleHttpSingleRequestProgressDelegate,const FSimpleHttpRequest , Request, uint64, BytesSent, uint64, BytesReceived);
...
DECLARE_DELEGATE_ThreeParams(FSimpleSingleRequestProgressDelegate, const FSimpleHttpRequest &, uint64, uint64);
