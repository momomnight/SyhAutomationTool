...
#endif
{
	...
	struct SIMPLEHTTP_API FHTTP
	{
		...
		*/
		...
		bool RequestByConentString(ESimpleHTTPVerbType InType, const FString& InURL, const TMap<FString, FString>& InHeadMeta, const FString& InContent, const FSimpleHTTPBPResponseDelegate& BPResponseDelegate);
		bool RequestByConentByte(ESimpleHTTPVerbType InType, const FString& InURL, const TMap<FString, FString>& InHeadMeta, const TArray<uint8>& InBytes, const FSimpleHTTPBPResponseDelegate& BPResponseDelegate);
		
		bool RequestByConentString(ESimpleHTTPVerbType InType, const FString& InURL, const TMap<FString, FString>& InHeadMeta, const FString& InContent, const FSimpleHTTPResponseDelegate& InResponseDelegate);
		bool RequestByConentByte(ESimpleHTTPVerbType InType, const FString& InURL, const TMap<FString, FString>& InHeadMeta, const TArray<uint8>& InBytes, const FSimpleHTTPResponseDelegate& InResponseDelegate);
		 ...
		 */
		bool PostRequest(const TCHAR *InURL, const TCHAR *InParam, const FSimpleHTTPBPResponseDelegate &BPResponseDelegate, bool bSynchronouse=false);
		 ...
		 */
		bool GetObjectToMemory(const FSimpleHTTPBPResponseDelegate &BPResponseDelegate, const FString &URL, bool bSynchronous=false);
		 ...
		 */
		void GetObjectsToMemory(const FSimpleHTTPBPResponseDelegate &BPResponseDelegate, const TArray<FString> &URL, bool bSynchronous = false);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromLocal(const FSimpleHTTPBPResponseDelegate &BPResponseDelegate, const FString &URL, const FString &LocalPaths, bool bSynchronouse=false);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectsFromLocal(const FSimpleHTTPBPResponseDelegate &BPResponseDelegate, const FString &URL, const FString &LocalPaths, bool bSynchronouse = false);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromString(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate, const FString& URL, const FString& InBuffer, bool bSynchronouse = false);
		 ...
		 * @param BPResponseDelegate		Proxy for site return.
		 */
		bool PostRequest(const TCHAR *InURL, const TCHAR *InParam, const FSimpleHTTPResponseDelegate &BPResponseDelegate, bool bSynchronouse = false);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool GetObjectToMemory(const FSimpleHTTPResponseDelegate &BPResponseDelegate, const FString &URL, bool bSynchronous=false);
		 ...
		 * @param URL					Need domain name .
		 */
		void GetObjectsToMemory(const FSimpleHTTPResponseDelegate &BPResponseDelegate, const TArray<FString> &URL, bool bSynchronous = false);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromLocal(const FSimpleHTTPResponseDelegate &BPResponseDelegate, const FString &URL, const FString &LocalPaths, bool bSynchronouse = false);
		bool PostObjectFromLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate, const FString& URL, const FString& LocalPaths, bool bSynchronouse = false);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectsFromLocal(const FSimpleHTTPResponseDelegate &BPResponseDelegate, const FString &URL, const FString &LocalPaths, bool bSynchronouse = false);
		bool PostObjectsFromLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate, const FString& URL, const FString& LocalPaths, bool bSynchronouse = false);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromString(const FSimpleHTTPResponseDelegate& BPResponseDelegate, const FString& URL, const FString& InBuffer, bool bSynchronouse=false);
	...
	private:
		bool RequestByConentString(FSimpleHTTPHandle Handle, ESimpleHTTPVerbType InType, const FString& InURL, const TMap<FString, FString>& InHeadMeta, const FString& InContent);
		bool RequestByConentByte(FSimpleHTTPHandle Handle, ESimpleHTTPVerbType InType, const FString& InURL, const TMap<FString, FString>& InHeadMeta, const TArray<uint8>& InBytes);
		 ...
		 */
		bool GetObjectToMemory(const FSimpleHTTPHandle &Handle,const FString &URL, bool bSynchronous = false);
		 ...
		 * @param Handle	Easy to find requests .
		 */
		void GetObjectsToMemory(const FSimpleHTTPHandle &Handle, const TArray<FString> &URL, bool bSynchronous = false);
		 ...
		 * @param Handle	Easy to find requests .
		 */
		bool PutObjectFromLocal(const FSimpleHTTPHandle &Handle, const FString &URL, const FString &LocalPaths, bool bSynchronouse = false);
		bool PostObjectFromLocal(const FSimpleHTTPHandle& Handle, const FString& URL, const FString& LocalPaths, bool bSynchronouse = false);
		 ...
		 * @param Handle	Easy to find requests .
		 */
		bool PutObjectsFromLocal(const FSimpleHTTPHandle &Handle, const FString &URL, const FString &LocalPaths, bool bSynchronouse=false);
		 ...
		 * @param Handle	Easy to find requests .
		 */
		bool PutObjectFromString(const FSimpleHTTPHandle& Handle, const FString& URL, const FString& Buffer, bool bSynchronouse = false);
		 ...
		 * @param InURL						Address to visit.
		 */
		bool PostRequest(const FSimpleHTTPHandle &Handle, const FString &URL, bool bSynchronouse = false);
