...
namespace SimpleHTTP
{
	namespace HTTP
	{
		FString HTTPVerbToString(ESimpleHTTPVerbType InVerbType);
		...
		{
			FObjectsRequest(ESimpleHTTPVerbType InType,const FString& URL, const TMap<FString, FString>& InMeta, const FString& InConentData);
			FObjectsRequest(ESimpleHTTPVerbType InType,const FString& URL, const TMap<FString, FString>& InMeta, const TArray<uint8>& InData);
		};
	}
}