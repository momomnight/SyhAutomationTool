...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "SimpleHTTP|SingleAction")
	static bool RequestByConentString(ESimpleHTTPVerbType InType, const FString& InURL,const TMap<FString,FString> &InHeadMeta,const FString &InContent,const FSimpleHTTPBPResponseDelegate& BPResponseDelegate);
	
	UFUNCTION(BlueprintCallable, Category = "SimpleHTTP|SingleAction")
	static bool RequestByConentByte(ESimpleHTTPVerbType InType,const FString& InURL, const TMap<FString, FString>& InHeadMeta, const TArray<uint8>& InBytes, const FSimpleHTTPBPResponseDelegate& BPResponseDelegate);
