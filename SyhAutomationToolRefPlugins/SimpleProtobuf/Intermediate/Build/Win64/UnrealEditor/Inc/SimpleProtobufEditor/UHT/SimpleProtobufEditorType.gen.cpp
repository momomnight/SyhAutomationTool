...
template<> SIMPLEPROTOBUFEDITOR_API UScriptStruct* StaticStruct<FProtobufMap>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FProtobufMap_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FProtobufMap, Key), METADATA_PARAMS(Z_Construct_UScriptStruct_FProtobufMap_Statics::NewProp_Key_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProtobufMap_Statics::NewProp_Key_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FProtobufMap_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FProtobufMap, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FProtobufMap_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProtobufMap_Statics::NewProp_Value_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FProtobufMap_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FProtobufMap_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProtobufMap_Statics::Struct_MetaDataParams))
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleProtobuf_Source_SimpleProtobufEditor_Public_SimpleProtobufEditorType_h_Statics::ScriptStructInfo[] = {
		{ FProtobufMap::StaticStruct, Z_Construct_UScriptStruct_FProtobufMap_Statics::NewStructOps, TEXT("ProtobufMap"), &Z_Registration_Info_UScriptStruct_ProtobufMap, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FProtobufMap), 910336641U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleProtobuf_Source_SimpleProtobufEditor_Public_SimpleProtobufEditorType_h_4009795128(TEXT("/Script/SimpleProtobufEditor"),
		nullptr, 0,
