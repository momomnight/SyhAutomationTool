...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USimpleProtobufCompileInfo_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(Z_Construct_UClass_USimpleProtobufCompileInfo_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USimpleProtobufCompileInfo_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleProtobuf_Source_SimpleProtobufEditor_Public_UObject_SimpleProtobufCompileInfo_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimpleProtobufCompileInfo, USimpleProtobufCompileInfo::StaticClass, TEXT("USimpleProtobufCompileInfo"), &Z_Registration_Info_UClass_USimpleProtobufCompileInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimpleProtobufCompileInfo), 908269862U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleProtobuf_Source_SimpleProtobufEditor_Public_UObject_SimpleProtobufCompileInfo_h_1136072528(TEXT("/Script/SimpleProtobufEditor"),
