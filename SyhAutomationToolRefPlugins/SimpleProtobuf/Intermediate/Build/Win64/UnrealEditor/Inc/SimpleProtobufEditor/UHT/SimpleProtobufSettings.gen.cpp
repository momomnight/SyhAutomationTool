...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_ProtoNames_Inner = { "ProtoNames", nullptr, (EPropertyFlags)0x0000000000024000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_ProtoNames = { "ProtoNames", nullptr, (EPropertyFlags)0x0010000000024001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(USimpleProtobufSettings, ProtoNames), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_ProtoNames_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_ProtoNames_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_CurrentSelected = { "CurrentSelected", nullptr, (EPropertyFlags)0x0010000000024001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(USimpleProtobufSettings, CurrentSelected), METADATA_PARAMS(Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_CurrentSelected_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_CurrentSelected_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_NewConfigName = { "NewConfigName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(USimpleProtobufSettings, NewConfigName), METADATA_PARAMS(Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_NewConfigName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USimpleProtobufSettings_Statics::NewProp_NewConfigName_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USimpleProtobufSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(Z_Construct_UClass_USimpleProtobufSettings_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USimpleProtobufSettings_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleProtobuf_Source_SimpleProtobufEditor_Public_UObject_SimpleProtobufSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimpleProtobufSettings, USimpleProtobufSettings::StaticClass, TEXT("USimpleProtobufSettings"), &Z_Registration_Info_UClass_USimpleProtobufSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimpleProtobufSettings), 1461610981U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_RENZHAI_PLUGIN_SimpleProtobuf_Source_SimpleProtobufEditor_Public_UObject_SimpleProtobufSettings_h_3708137907(TEXT("/Script/SimpleProtobufEditor"),
